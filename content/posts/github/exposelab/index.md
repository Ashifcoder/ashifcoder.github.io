+++
title = 'Expose Lab: Automated Active Directory Lab + Mini CTF Inside!'
date = 2023-03-17
draft = false
+++

{{< github repo="Ashifcoder/exposelab" >}}
...
<img class="thumgnailshadow" src="lab.png">
...
{{< youtubeLite id="zx4pJ2XewYo" label="Blowfish-tools demo" >}}


2. Solving the Mini CTF Challange!

{{< youtubeLite id="d3QFLLOqefo" label="expose_lab_ctf" >}}
...
<img class="thumgnailshadow" src="gplv3.png">
